#!/usr/bin/env python3
"""
Cross-Exchange Hedge Bot - Entry point
"""
...
from cross_exchange_hedge_bot import CrossExchangeHedgeBot, CrossHedgeConfig


def parse_arguments():
    """Parse command line arguments."""
    parser = argparse.ArgumentParser(
        description='Cross-Exchange Hedge Bot - Paradex ↔ Lighter Hedging for Volume Generation'
    )
...
def validate_env_variables():
    ...
    if missing_vars:
        ...
        print("  # Paradex Configuration")
        print("  PARADEX_L1_ADDRESS=<your_l1_address>")
        print("  PARADEX_L2_PRIVATE_KEY=<your_l2_private_key>")
...
async def main():
    ...
    bot = CrossExchangeHedgeBot(config)
    try:
        await bot.run()
